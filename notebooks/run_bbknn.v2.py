...
sc.pp.highly_variable_genes(adata, flavor="seurat_v3", n_top_genes=4000, subset=True, layer="counts", batch_key="batch")
...
adata.write_h5ad("/home/sduan/projects/immune-atlas/data/processed/scrup/harmonized.scanpy.processed.v2.h5ad")
