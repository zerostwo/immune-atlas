if (TRUE) {
  ...
  outdir <- sn_set_path("/home/sduan/projects/immune-atlas/data/processed/TabulaSapiens/batches/corrected")
  
  files <- list.files("/home/sduan/projects/immune-atlas/data/processed/TabulaSapiens/corrected/bpcells", pattern = "qs", full.names = TRUE)
  head(files)
  ...
  walk2(batches, seq_along(batches), function(batch_files, i) {
    ...
    if (!file.exists(qs_file)) {
      ...
      merged <- JoinLayers(object = merged, layers=c("counts", "decontaminated_counts"))
...
if (TRUE) {
  ...
  # )
  # 
    seurat_obj_lists <- list.files("/home/sduan/projects/immune-atlas/data/processed/TabulaSapiens/batches/corrected/",pattern = ".qs$",
             full.names = TRUE) %>% 
    map(sn_read)
  merged <- merge(seurat_obj_lists[[1]],
                      seurat_obj_lists[-1])
  merged <- JoinLayers(merged)
  sn_write(merged, "/home/sduan/projects/immune-atlas/data/processed/TabulaSapiens/merged_corrected.qs")
}
