...
outdir <- sn_set_path("data/processed/MarylineFalquet2023/corrected_soupx")
#
dirs <- sn_list_10x_paths("/home/sduan/data/MarylineFalquet2023",
                          path_type = "filtered_h5")
samples <- names(dirs)
raw <- sn_list_10x_paths("/home/sduan/data/MarylineFalquet2023",
                         path_type = "raw_h5")
