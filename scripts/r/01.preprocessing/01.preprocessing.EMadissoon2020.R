...
outdir <- sn_set_path("data/processed/EMadissoon2020/corrected_soupx")

dirs <- sn_list_10x_paths("/home/sduan/data/EMadissoon2020/", path_type = "filtered_h5")
raw <- sn_list_10x_paths("/home/sduan/data/EMadissoon2020/", path_type = "raw_h5")

samples <- names(dirs)
# samples <- list.files(file.path(outdir, "seurat_object"),
#                       pattern = "qs") %>% str_remove_all(".qs22")
