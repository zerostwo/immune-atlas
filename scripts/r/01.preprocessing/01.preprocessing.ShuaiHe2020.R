...
outdir <- sn_set_path("data/processed/ShuaiHe2020/corrected_soupx")

dirs <- sn_list_10x_paths("/home/sduan/data/ShuaiHe2020",
                          path_type = "filtered_h5")
samples <- names(dirs)
raw <- sn_list_10x_paths("/home/sduan/data/ShuaiHe2020",
                         path_type = "raw_h5")
