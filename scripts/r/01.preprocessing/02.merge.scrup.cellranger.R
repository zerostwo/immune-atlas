if (FALSE) {
  ...
  outdir <- sn_set_path("/home/sduan/projects/immune-atlas/data/processed/scrup/batches/cellranger")
  
  files <- list.files("/home/sduan/projects/immune-atlas/data/processed/scrup/cellranger/bpcells/", pattern = "qs", full.names = TRUE)
  head(files)
...
if (TRUE) {
  ...
  # )
  # 
  seurat_obj_lists <- list.files("/home/sduan/projects/immune-atlas/data/processed/scrup/batches/cellranger",pattern = ".qs$",
             full.names = TRUE) %>% 
    map(sn_read)
  merged <- merge(seurat_obj_lists[[1]],
                      seurat_obj_lists[-1])
  merged <- JoinLayers(merged)
  sn_write(merged, "/home/sduan/projects/immune-atlas/data/processed/scrup/cellranger.merged.qs")
}
