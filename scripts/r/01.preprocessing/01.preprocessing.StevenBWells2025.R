...
outdir <- sn_set_path("data/processed/StevenBWells2025/corrected")

dirs <- sn_list_10x_paths("/home/sduan/data/StevenBWells2025/alignments/count")

samples <- names(dirs)
samples <- samples[!(samples %in% c("621B_CZI-IA10244335"))]
for (sample in samples) {
  # sample <- samples[1]
  # sample <- "621B_CZI-IA10244335"
  print(sample)
...
if (FALSE) {
  outdir <- sn_set_path("data/processed/20260328/StevenBWells2025")
  
  samples <- list.files("/home/sduan/data/StevenBWells2025/alignments/count/")
  filtered_data_dirs <- glue("/home/sduan/data/StevenBWells2025/alignments/count/{samples}/outs/filtered_feature_bc_matrix/")
